                ...
                <div className="row" style={{ position: "relative", zIndex: 2 }}>
                  <div className="col-lg-4">
                    <div className="contact-info-list">
                      <div className="contact-info-item wow fadeInUp" style={{ marginBottom: "30px" }}>
                      ...
                      <div className="contact-info-item wow fadeInUp" data-wow-delay="0.2s" style={{ marginBottom: "30px" }}>
                        <div className="icon-box">
                          <img src="/assets/images/icon-mail-accent.svg" alt="Email" />
                        </div>
                        <div className="contact-info-content">
                          <h3 style={{ color: "#fff" }}>E-mail</h3>
                          <p><a href="mailto:contact@octopustalent.com" style={{ color: "rgba(255,255,255,0.8)" }}>contact@octopustalent.com</a></p>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-8">
                    <div className="contact-us-form">
                      <div className="section-title dark-section wow fadeInUp">
                        <h2 style={{ color: "#fff", marginBottom: "30px" }}>Entrez en contact avec nous</h2>
                      </div>
